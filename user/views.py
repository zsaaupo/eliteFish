    ...
    def post(self, request):
        ...
        try:
            ...
            if 'name' not in data or data['name'] == '':
                result['message'] = "Name can not be null."
            ...
            if 'designation' not in data or data['designation'] == '':
                result['message'] = "Designation can not be null."
            ...
            if not user:
                ...
                result['message'] = "This user already have a account"
                return Response(result)
            ...
            if user:
                ...
                if 'active' in data:
                    if data['active'] == '' or data['active'] not in [0, 1]:
                        result['message'] = "Wrong active status."
                        result['error'] = "active"
                        return Response(result, status=HTTP_400_BAD_REQUEST)
                    else:
                        ...
                        match activeStatus:
                            case 0:
                                if user.is_active == 1:
                                    ...
                                    result['message'] = "User already deactivated"
                                    return Response(result)
                            case 1:
                                if user.is_active == 0:
                                    user.is_active = data['active']
