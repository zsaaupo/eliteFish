...
class BuyAdmin(admin.ModelAdmin):
    list_display = ('invoice_no', 'supplier_name', 'supplier_phone', 'supplier_address', 'buying_manager', 'product', 'quantity', 'unit_price', 'total_amount', 'created_by', 'modified_by', 'created_at', 'modified_at')
